# LWA Whop Product Setup

This document is the paste-ready structure for selling **LWA - AI Content Repurposer** on Whop.
...
- Experience name: `LWA Community`
- Purpose: user wins, clip feedback, troubleshooting, retention
- Pinned prompt:
...
- Experience name: `Clipping Tutorials`
- Purpose: onboarding and conversion from free to paid
- Initial modules:
...
- Experience name: `Updates and Announcements`
- Purpose: product releases, new features, launch notes, retention touchpoint
- First post title: `LWA Is Live`
- First post body:
...
If you are running serious output or team workflows, Scale is the move.
```
...
- `Paste a video URL and generate clip-ready ideas fast`
...
`Get in fast. Test the workflow. Generate 3 clips per day and see what LWA can do for your content output.`
...
### What Users See After Purchase

Immediately after purchase, they should land in this order:
...
1. Open the app
2. Paste a video URL
3. Generate your first clips
4. Post them to your target platform
5. Come back and improve the next batch
```

### How They Access The App

- Free and paid users get access through the product membership
- The pinned `Start Here` section contains:
  - app link
  - login or access instructions
  - quick-start video
  - FAQ

### How They Start Generating Clips Immediately

Use this as the first quick-start checklist:

1. Open LWA
2. Paste a long-form video URL
3. Pick a target platform
4. Generate clips
5. Choose the best hook
6. Export or post manually
7. Track which angle performs best

## Free To Pro Funnel

### Conversion Strategy

- Let Free users feel the product immediately
- Limit them by output, not by understanding
- Show the upgrade exactly when they hit the volume ceiling

### Recommended Funnel

1. User joins Free
2. User generates first 3 clips
3. User sees watermark and daily cap
4. Upgrade prompt appears:

```text
You used your free clips for today.

Upgrade to Pro to unlock unlimited generations, better captions, stronger hooks, and no watermark.
```

5. Offer a simple incentive:
  - `7-day Pro trial`, or
  - `first month at $9`, or
  - `unlock 25 extra clips today by upgrading`
...
- Create the `LWA - AI Content Repurposer` product
- Add Free, Pro, and Scale plans
- Add the 3 experiences
- Paste the product page copy above
- Pin the welcome message
- Add the app link to `Start Here`
- Add the upgrade callout inside Free onboarding
- Announce launch inside the updates section
