  ...
  const content = (
    <span className={["inline-flex items-center gap-3.5", className].join(" ")}>
      <span className={["logo-mark-shell", animated ? "logo-mark-shell-animated" : ""].join(" ")}>
        ...
        <span className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_34%_22%,var(--surface-gold-glow),transparent_34%),radial-gradient(circle_at_76%_72%,var(--gold-dim),transparent_36%),radial-gradient(circle_at_62%_20%,var(--surface-soft),transparent_36%)]" />
