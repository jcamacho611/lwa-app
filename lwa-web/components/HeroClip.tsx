...
export default function HeroClip({
  ...
  const confidenceLabel = formatConfidence(clip.confidence);
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,0.68fr),minmax(320px,0.32fr)] xl:items-start">
          ...
          <div className="video-shell overflow-hidden rounded-[28px] border border-white/10 bg-black/50">
            ...
            <div className="video-overlay pointer-events-none absolute inset-x-0 bottom-0 flex items-end justify-between gap-3 p-4">
              <div className="flex flex-wrap gap-2">
                <span className="status-chip status-approved">Top clip</span>
              ...
              {clip.best_post_order ? <span className="status-chip status-draft">Post #{clip.best_post_order}</span> : null}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-5">
          <div className="space-y-3">
            <p className="section-kicker">Hero clip</p>
          ...
          {clip.thumbnail_text ? (
            <div className="metric-tile rounded-[24px] p-4">
              <p className="mb-2 text-xs uppercase tracking-[0.24em] text-muted">Thumbnail</p>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {downloadUrl ? (
              ...
              <span className="rounded-full border border-neonPurple/20 bg-neonPurple/10 px-4 py-3 text-sm text-white/76">
                Upgrade to download
              </span>
            )}
            <button
