...
export default function VideoCard({
  ...
  async function handleSaveWinner() {
    try {
      ...
      // eslint-disable-next-line no-console
      console.warn("[VideoCard] Failed to save winner:", error);
    }
  }
  ...
  async function handleRejectAndLearn() {
    try {
      ...
      // eslint-disable-next-line no-console
      console.warn("[VideoCard] Failed to submit rejection:", error);
    }
  }
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
            ...
            {!compact && (
              <button
                ...
                className="rounded-full border border-emerald-300/25 bg-emerald-300/10 px-4 py-2 text-sm font-medium text-emerald-100 transition hover:bg-emerald-300/20"
              >
                Save winner
              </button>
            )}
            ...
            {!compact && (
              <button
                ...
                className="rounded-full border border-red-300/20 bg-red-300/10 px-4 py-2 text-sm font-medium text-red-100 transition hover:bg-red-300/20"
              >
                Reject & learn
              </button>
            )}
