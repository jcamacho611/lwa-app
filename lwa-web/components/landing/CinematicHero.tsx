...
export default function CinematicHero() {
  return (
    <section className="relative flex min-h-[88vh] items-center overflow-hidden">
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            <span className="inline-flex h-9 w-9 items-center justify-center rounded-md bg-[#16161B] ring-1 ring-[#2E2E38]">
              <span className="text-lg font-semibold leading-none text-[#C9A24A]">L</span>
            </span>
          ...
          <p className="mt-4 max-w-xl text-sm leading-6 text-[#8F897C]">
            Lee-Wuh is the mascot for the creator engine: Afro-futurist,
            anime-inspired energy wrapped around a real clipping product.
          </p>
